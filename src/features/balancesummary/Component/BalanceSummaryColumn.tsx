...
function BalanceSummaryColumn({children}: { children: ReactNode}) {
  return (
    <div className="hiddelg:flex flex-col lg:sticky lg:top-0 lg:w-[32rem] lg:h-screen lg:bg-primary-bg-color  lg:dark:bg-gray-800 lg:rounded-l lg:shadow-lg lg:pt-0 " >

                ...
                <div className="relative flex flex-col text-center lg:text-right" data-aos="zoom-y-out" ref={tabs}>
                  ...
                  >
                    <div className="relative inline-flex flex-col">
                      <img className="md:max-w-none mx-auto rounded-xl shadow-xl " src={FeaturesBg} width={450} height="400" alt="Features bg" />
                    </div>
                  </Transition>
                  {/* Item 2 */}
                  <Transition
                  ...
                  >
                    <div className="relative inline-flex flex-col">
                      <img className="md:max-w-none mx-auto rounded-xl shadow-xl" src={GroupExpense} width={450} height="400" alt="Features bg" />
                    </div>
                  </Transition>
                  {/* Item 3 */}
                  <Transition
                  ...
                  >
                    <div className="relative inline-flex flex-col">
                      <img className="md:max-w-none mx-auto rounded-xl shadow-xl" src={AddExpense} width={450} height="400" alt="Features bg" />
                    </div>
                  </Transition>
                  <Transition
                    show={tab === 4}
                  ...
                  >
                    <div className="relative inline-flex flex-col">
                      <img className="md:max-w-none mx-auto rounded-xl shadow-xl" src={SettleUP} width={450} height="400" alt="Features bg" />
                    </div>
                  </Transition>
